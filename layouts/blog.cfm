...
<html class="no-js"> <!--<![endif]-->
    <head>
		...
		<!-- injector:css -->
		<link rel="stylesheet" href="#cb.themeRoot()#/includes/css/63c48ff6.theme.min.css">
		<!-- endinjector -->
		...
		<!--- ********************************************************************************* --->
		<!-- injector:js -->
		<script src="#cb.themeRoot()#/includes/js/89a27fc7.theme.min.js"></script>
		<!-- endinjector -->
	    ...
	    <div id="content" class="site-content">
	        ...
	        <div class="container main-content-area">
	            ...
	            <div class="row">
	                ...
	                <!-- blog-contents -->
	                <section class="main-content-inner col-sm-12 col-md-8">
